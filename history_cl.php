...
$client_li="";
$sql=$db->query("SELECT * FROM transactions WHERE username_cl='$username' ORDER BY date_transaction DESC");
if(($sql->num_rows)>0){
	$rows=$sql->fetch_all(MYSQLI_ASSOC);
	foreach($rows as $rows){
	$id=$rows["id_trans"];
	...
	$amount=$rows["amount"];
	///////////////////////////////////////////////////////////////////////////////////////////////////////
      $client_li.="<tr><td>$date</td><td>$amount</td></tr>";
	 /////////////////////////////////////////////////////////////////////////////////
	}
	}
	else{
		 $client_li="Hauna Historia";
		}
...
<div align="center" id="wrapper">
  ...
  <div align="left" style="margin-left:24px;">
      <h2 align="center">Historia Ya Mauzo</h2>
